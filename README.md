...
![AX5 Plotter](https://img.shields.io/badge/Hardware-AX5_Plotter-blue)
![Python](https://img.shields.io/badge/Python-3.8+-green)
![License](https://img.shields.io/badge/License-MIT-yellow)

**Simple desktop application for converting photos to sketches and plotting them on your AX5 pen plotter.**
...
### Batch Processing
For multiple images, you can use the `simple_converter.py` script for batch processing from the command line.
...
4. Check that your GRBL firmware is properly configured for servo control
